...
namespace Error {
	ERROR errors[ERROR_MAX_ENTRY] =
	{
		...
		ERROR_ENTRY(301, "{ SEMANTIC } Имеется более одной точки входа в glavnaya"),
		ERROR_ENTRY(302, "{ SEMANTIC } Не имеется точки входа в glavnaya"),
		...
		ERROR_ENTRY(306, "{ SEMANTIC } Попытка переопределить переменную/функцию"),
		...
		ERROR_ENTRY(310, "{ SEMANTIC } Недопустимый оператор в условии"),
		ERROR_ENTRY(311, "{ SEMANTIC } Недопустим вывод арифметического выражения или вызова функции"),
		...
		ERROR_ENTRY(317, "{ SEMANTIC } Значение переменной типа string выходит за пределы допустимых значений"),
		ERROR_ENTRY(318, "{ SEMANTIC } Превышение значения переменной допустимого размера типа данных"),
		ERROR_ENTRY(319, "{ SEMANTIC } Превышение количества передаваемых параметров в функцию"),
		ERROR_ENTRY_NODEF(320),ERROR_ENTRY_NODEF(321),
		...
		ERROR_ENTRY(612,"{ SYNTACTIC } синтаксический анализатор экстренно завершил работу "),
		ERROR_ENTRY(613,"{ SYNTACTIC } Превышена длина идентификатора "),
