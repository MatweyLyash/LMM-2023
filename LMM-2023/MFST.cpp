...
#pragma region CONSTRUCTORS
	...
	{
		lentaPosition = plenta_position;//позици€ на ленте
		rcStep = prc_step;//код завершени€ шага
...
#pragma endregion
	...
	{
		out << "\n-----------–абота синтаксического анализатора-----------\n" << std::endl;
		bool rc = false;
	...
	void SyntacticAnalysis(Lexis::LEX lex, Log::LOG log, std::ostream& out)
	{
		...
		{
			std::cout << Error::geterror(612).message << ",\nдл€ большей информации смотрите log файл\n";
