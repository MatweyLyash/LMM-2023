...
#define FST_NOTINTLIT 4,\
	FST::NODE(1, FST::RELATION('-', 1)),\
	FST::NODE(9, FST::RELATION('1', 2), \
...
#define FST_OPERATOR 2,	\
	FST::NODE(12, FST::RELATION('+', 1), FST::RELATION('-', 1), FST::RELATION('*', 1), FST::RELATION('/', 1), FST::RELATION('%', 1),\
	FST::RELATION('>', 1), FST::RELATION('<', 1), FST::RELATION('~', 1), FST::RELATION('!', 1),\
	FST::RELATION('O', 1),FST::RELATION('A', 1),FST::RELATION('N', 1)),\
	FST::NODE()
