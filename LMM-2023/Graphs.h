...
#define FST_NOTINTLIT 5,\
	FST::NODE(1, FST::RELATION('-', 2)),\
	FST::NODE(2, FST::RELATION('1', 3), \
	...
	FST::NODE(3, FST::RELATION('0', 4),\
		FST::RELATION('1', 4), FST::RELATION('2', 4),\
		FST::RELATION('3', 4), FST::RELATION('4', 4),\
		FST::RELATION('5', 4), FST::RELATION('6', 4),\
		FST::RELATION('7', 4), FST::RELATION('8', 4),\
		FST::RELATION('9', 4)),\
	FST::NODE(4, FST::RELATION('0', 4),\
		FST::RELATION('1', 4), FST::RELATION('2', 4),\
		FST::RELATION('3', 4), FST::RELATION('4', 4),\
		FST::RELATION('5', 4), FST::RELATION('6', 4),\
		FST::RELATION('7', 4), FST::RELATION('8', 4),\
...
#define FST_STRLIT 3, \
	...
	FST::RELATION('ё', 1), FST::RELATION('ж', 1), FST::RELATION('з', 1), FST::RELATION('и', 1), FST::RELATION('к', 1), FST::RELATION('л', 1),\
	FST::RELATION('м', 1), FST::RELATION('н', 1), FST::RELATION('о', 1), FST::RELATION('п', 1), FST::RELATION('р', 1), FST::RELATION('с', 1),\
	FST::RELATION('т', 1), FST::RELATION('у', 1), FST::RELATION('ф', 1), FST::RELATION('х', 1), FST::RELATION('ц', 1), FST::RELATION('ч', 1),\
	FST::RELATION('ш', 1), FST::RELATION('щ', 1), FST::RELATION('ъ', 1), FST::RELATION('ы', 1), FST::RELATION('ь', 1), FST::RELATION('э', 1),\
	...
	FST::RELATION('Т', 1), FST::RELATION('У', 1), FST::RELATION('Ф', 1), FST::RELATION('Х', 1), FST::RELATION('Ц', 1), FST::RELATION('Ч', 1),\
	FST::RELATION('Ш', 1), FST::RELATION('Щ', 1), FST::RELATION('Ъ', 1), FST::RELATION('Ы', 1), FST::RELATION('Ь', 1), FST::RELATION('Э', 1),\
	FST::RELATION('?', 1), FST::RELATION('!', 1),FST::RELATION('&', 1), FST::RELATION(';', 1), FST::RELATION(':', 1), FST::RELATION('-', 1), FST::RELATION(')', 1),\
	FST::RELATION('Ю', 1), FST::RELATION('Я', 1), FST::RELATION(' ', 1), FST::RELATION('.', 1), FST::RELATION(',', 1),\
	FST::RELATION('(', 1),FST::RELATION('\"',2),FST::RELATION('>', 1),FST::RELATION('<', 1),FST::RELATION('^', 1),\
...
#define FST_OPERATOR 2,	\
	FST::NODE(11, FST::RELATION('+', 1), FST::RELATION('-', 1), FST::RELATION('*', 1), FST::RELATION('/', 1), FST::RELATION('%', 1),\
	FST::RELATION('>', 1), FST::RELATION('<', 1), FST::RELATION('~', 1), FST::RELATION('!', 1),\
	FST::RELATION('O', 1),FST::RELATION('A', 1)),\
	FST::NODE()
